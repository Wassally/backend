...
ConnectionInfo = _mod_psycopg2_extensions.ConnectionInfo
def DATE():
    'psycopg type-casting object'
    pass
...
__file__ = '/home/mahmoudzeyada/projects/delivery_project/env/lib/python3.7/site-packages/psycopg2/_psycopg.cpython-37m-x86_64-linux-gnu.so'
__libpq_version__ = 110002
__name__ = 'psycopg2._psycopg'
__package__ = 'psycopg2'
__version__ = '2.8.2 (dt dec pq3 ext lo64)'
def _connect(dsn, connection_factory=None, async_=None):
...
sqlstate_errors = _mod_builtins.dict()
